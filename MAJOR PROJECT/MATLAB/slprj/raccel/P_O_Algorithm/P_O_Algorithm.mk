...
MODEL               = P_O_Algorithm
MODULES             = rt_logging.c P_O_Algorithm.c P_O_Algorithm_capi.c P_O_Algorithm_data.c P_O_Algorithm_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE            = P_O_Algorithm.mk
...
RACCEL_PARALLEL_EXECUTION_NUM_THREADS = 8
...
MODELLIB                  = P_O_Algorithmlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P_O_Algorithm_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/P_O_Algorithm \
